...
//                                               "light within 60 feet as if it were bright light, and in darkness as if it were dim light. You
//                                               can't" +
...
//                                       " +
//                                               "allows you to hide messages in seemingly normal conversation. Only another creature " + "that
//                                               knows" +
...
//                                       "Your quick thinking and agility allow you to move and act quickly. You can " + "take a bonus action on
//                                       each" +
//                                               " of your turns in combat. This action can only be used to take the Dash, Disengage, or Hide
//                                               action."),
...
//                                       turn, " +
//                                               "you can deal an extra 1d6 damage to one creature you hit with an attack if you have" + "
//                                               advantage " +
//                                               "on the attack roll. The attack must use a finesse or ranged weapon.\n" + "\n" + "You don't need "
//                                               + "advantage on the attack roll if another enemy of the target is within 5 feet of it, that enemy
//                                               isn't " + "incapacitated, and you don't have disadvantage on the attack roll.\n" + "\n" + "The
//                                               amount of the extra damage " + "increases as you gain levels in this class, yell at Thomas to
//                                               figure out how much dice you roll for DAMAGEEE"),
//                           new Feature("Assassinate", "Rogue",
//                                       "You have advantage against attack rolls against any creature who hasn't taken their " + "turn in combat
//                                       yet" +
...
//                                       "When the attacker that you can see hits you with an attack, you can use your reaction to halve the
//                                       attack's damage to you.")
//                          );
